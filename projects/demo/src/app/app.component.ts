    ...
    <main class="demo">
      <header class="demo__header">
        ...
        <p>
          ...
          for client-side and server-driven tables. Data from sample API
          (<code>npm start</code> → port 3000).
        </p>
      </header>
      ...
      >
        <p class="demo__hint">
          <code>GET /api/users</code> — <code>setRowData()</code>, client
          pagination, inline edit via <code>PATCH /api/users/:id</code>.
        </p>
      ...
      >
        <p class="demo__hint">
          <code>GET /api/orders?offset&amp;limit&amp;sort&amp;filter</code> —
          <code>createInfiniteDatasource()</code>, 500 rows from sample backend.
        </p>
        <section class="demo__toolbar">
